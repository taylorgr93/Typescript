(() => {
  let avenger: any = 123; // variable avenger de tipo any con valor inicial 123
  ...
  console.log((avenger as string).charAt(0)); // se convierte avenger a string y se llama a charAt en la primera letra (D)
  ...
  console.log(<number>avenger.toFixed(2)); // se convierte avenger a número y se llama a toFixed con 2 decimales (150.23)
